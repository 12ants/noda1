<?php
/**
 * noda1 functions and definitions
 *
 ...
 */
function noda1_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on noda1, use a find and replace
		* to change 'noda1' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'noda1', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'noda1' ),
		)
	);
...
add_action( 'after_setup_theme', 'noda1_setup' );
 ...
 */
function noda1_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'noda1_content_width', 640 );
}
add_action( 'after_setup_theme', 'noda1_content_width', 0 );
 ...
 */
function noda1_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'noda1' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'noda1' ),
...
add_action( 'widgets_init', 'noda1_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function noda1_scripts() {
	wp_enqueue_style( 'noda1-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'noda1-style', 'rtl', 'replace' );

	wp_enqueue_script( 'noda1-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'noda1_scripts' );
